...
export const CelebrationSection: React.FC<CelebrationSectionProps> = ({
  ...
  return (
    <section id="celebration" className="py-16 sm:py-24 bg-gradient-to-b from-rose-50/60 via-amber-50/40 to-pink-50/50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="rounded-3xl p-5 sm:p-8 md:p-12 bg-white border-2 border-pink-200/90 shadow-xl max-w-4xl mx-auto mb-14 sm:mb-16 relative">
